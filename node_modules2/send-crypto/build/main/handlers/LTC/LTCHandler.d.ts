...
export declare const _apiFallbacks: {
    ...
    fetchUTXOs: (testnet: boolean, address: string, confirmations: number, scriptHash?: string | undefined) => (() => Promise<UTXO[]>)[];
    fetchTXs: (testnet: boolean, address: string, confirmations?: number, scriptHash?: string | undefined) => (() => Promise<UTXO[]>)[];
    broadcastTransaction: (testnet: boolean, hex: string) => (() => Promise<string>)[];
};
export declare class LTCHandler implements Handler {
